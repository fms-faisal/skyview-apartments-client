    ...
    <div className="flex justify-center items-center h-full">
      ...
      <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
        ...
        <div className="flex items-center px-6 py-3 bg-gray-900">
          ...
          <h1 className="mx-3 text-lg font-semibold text-white">Apartment No: {reservation[0].apartment_no}</h1>
        </div>

        <div className="px-6 py-4">
          <h1 className="text-xl font-semibold text-gray-800 dark:text-white"> {user.displayName}</h1>

          <p className="py-2 text-gray-700 dark:text-gray-400">      {user.email}</p>
          ...
          <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 className="px-2 text-sm">Block : {reservation[0].block_name}</h1>
          </div>
          ...
          <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 className="px-2 text-sm">Floor : {reservation[0].floor_no}</h1>
          </div>
          ...
          <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 className="px-2 text-sm">Rent : {reservation[0].rent}</h1>
          </div>
        </div>
      </div>
    </div>
