    ...
    <div className="flex justify-center items-center h-full">
      <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
        ...
        <div className="flex items-center px-6 py-3 bg-gray-900">
          ...
          <h1 className="mx-3 text-lg font-semibold text-white">{user.displayName}</h1>
        </div>

        <div className="px-6 py-4">
          <h1 className="text-xl font-semibold text-gray-800 dark:text-white"> {user.email}</h1>

          <p className="py-2 text-gray-700 dark:text-gray-400">Total Apartments:  {apartments.length}</p>
